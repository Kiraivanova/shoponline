...
class CategoryFeature(models.Model):
    ...
    category = models.ForeignKey("mainap.Category", verbose_name='Категория', on_delete=models.CASCADE)
...
class ProductFeatures(models.Model):
    ...
    product = models.ForeignKey("mainap.Product", verbose_name='Товар', on_delete=models.CASCADE)
